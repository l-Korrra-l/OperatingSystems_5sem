...
int main()
{
    ...
    printFileInfo((LPWSTR)L"C:\\Users\\User\\Documents\\ОСиСП\\OperationSystems_5sem\\лабы\\09. File System\\OS09_01.txt");
    printFileTxt((LPWSTR)L"C:\\Users\\User\\Documents\\ОСиСП\\OperationSystems_5sem\\лабы\\09. File System\\OS09_01.txt");
    system("pause");
}
...
BOOL printFileInfo(LPWSTR FileName)
{
    ...
    try
    {
        HANDLE of = CreateFile(
            FileName, GENERIC_WRITE | GENERIC_READ,
            NULL,
            NULL,
            OPEN_ALWAYS,
