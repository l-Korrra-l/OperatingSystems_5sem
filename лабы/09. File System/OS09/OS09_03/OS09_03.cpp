...
int main()
{
    ...
    LPWSTR fileName = (LPWSTR)L"C:\\Users\\User\\Documents\\ОСиСП\\OperationSystems_5sem\\лабы\\09. File System\\OS09_01.txt";

    printFileTxt(fileName);

    insRowFileTxt(fileName, (LPWSTR)L"0.Test Test", 0);
    insRowFileTxt(fileName, (LPWSTR)L"-1. Minus Minus", -1);
    insRowFileTxt(fileName, (LPWSTR)L"4. House Home", 4);
    insRowFileTxt(fileName, (LPWSTR)L"7. Seven Seven", 7);
